...
Monster Hunter Generations Ultimate, and all of its models, textures, animations, armor
names and data tables, are © CAPCOM CO., LTD. All rights reserved.
...
- **RevilLib / RevilToolset** — PredatorCZ (Lukas Cone).
  ...
  textures to DDS, `.lmt` motion lists to animation, and `.plpartsdisp` to XML.
...
linked from the app's "Other MHGU Apps" dialog.
